...
elseif &background == "dark"
    ...
    hi Comment gui=italic guifg=#584b4d guibg=NONE
    hi Conceal gui=NONE guifg=#808080 guibg=NONE
    hi Conditional gui=NONE guifg=#a22f2f guibg=NONE
    hi Constant gui=NONE guifg=#808080 guibg=NONE
    hi Cursor gui=reverse guifg=NONE guibg=NONE
    hi CursorColumn gui=NONE guifg=NONE guibg=#1a1a1a
    hi CursorLine gui=NONE guifg=NONE guibg=#27211b
    ...
    hi Folded gui=NONE guifg=#707070 guibg=#27211b
    hi Ignore gui=NONE guifg=NONE guibg=NONE
    ...
    hi Normal gui=NONE guifg=#cac8af guibg=#110e0e
    hi Number gui=NONE guifg=#7f7666 guibg=NONE
    ...
    hi Statement gui=NONE guifg=#ff6347 guibg=NONE
    hi StatusLine gui=NONE guifg=#9e9e9e guibg=#262626
    hi StatusLineNC gui=NONE guifg=#707070 guibg=#262626
    hi StorageClass gui=bold guifg=#e3e5c8 guibg=NONE
    hi String gui=NONE guifg=#795d79 guibg=NONE
    ...
    hi Todo gui=standout guifg=NONE guibg=NONE
    hi Type gui=NONE guifg=#9a4f42 guibg=NONE
    hi Underlined gui=NONE guifg=NONE guibg=NONE
