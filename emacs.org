...
** Brighten or Darken colour
   ...
   #+begin_src emacs-lisp
	 ...
	 (color-rgb-to-hex
	  (/ (+ red (* (- delta red) 0.15)) 255)
	  (/ (+ green (* (- delta green) 0.15)) 255)
	  (/ (+ blue (* (- delta blue) 0.15)) 255)
	  2)))
   #+end_src
* Custom File
...
*** Leading headline stars colour
    By default ~org-hide~ is a face applied to N-1 leading stars and the
    foreground colour is set to the default background colour. I want
    it to apply to _ALL_ stars.
    #+begin_src emacs-lisp
      (font-lock-add-keywords
       'org-mode
       '(("^\\*+ " . 'org-hide)))
